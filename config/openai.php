...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Default model to use for print analysis. Must support vision and file
    | attachments (gpt-4o recommended).
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Maximum number of PDF pages to send to the API for cost control.
    */
    'max_pages_analyze' => (int) env('OPENAI_MAX_PAGES_ANALYZE', 3),
];
